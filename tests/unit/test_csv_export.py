...
def test_export_cycle_time_csv_basic():
    ...
    rows = [
        {
            ...
            "resolved": "2025-11-04T16:00:00.000+0000",
            "cycle_time_days": 2.0,
        },
        {
            "id": "2",
            ...
            "resolved": "2025-12-27T17:00:00.000+0000",
            "cycle_time_days": 1.0,
        },
    ]
    ...
    assert lines[1].startswith(
        "1,TEST-1,2025-11-01T10:00:00.000+0000,2025-11-04T16:00:00.000+0000,2.0"
    )
    assert lines[2].startswith(
        "2,TEST-2,2025-12-24T09:00:00.000+0000,2025-12-27T17:00:00.000+0000,1.0"
    )
...
def test_export_cfd_csv():
    ...
    rows = [
        {"Date": "2023-01-01", "Open": 2, "In Progress": 1, "Done": 0},
        {"Date": "2023-01-02", "Open": 1, "In Progress": 2, "Done": 1},
    ]
